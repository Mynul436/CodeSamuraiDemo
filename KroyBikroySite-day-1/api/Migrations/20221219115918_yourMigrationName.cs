        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletionTime = table.Column<DateOnly>(type: "date", nullable: false),
                    TotalBudget = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AffiliatedAgencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AffiliatedAgencies_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Logitude = table.Column<double>(type: "double", nullable: false),
                    ProjectId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AffiliatedAgencies_ProjectId",
                table: "AffiliatedAgencies",
                column: "ProjectId");
